...
public:
  AnomalyDetector() : Node("anomaly_detector") {
    ...
    detection_pub_ = create_publisher<spar_air::msg::Detection>(
...
private:
  void process(const sensor_msgs::msg::Image::ConstSharedPtr& color) {
    ...
    spar_air::msg::Detection detection;
  ...
  rclcpp::Publisher<spar_air::msg::Detection>::SharedPtr detection_pub_;
...
int main(int argc, char** argv) {
  ...
  rclcpp::spin(std::make_shared<spar_air::AnomalyDetector>());
  rclcpp::shutdown();
  return 0;
}
